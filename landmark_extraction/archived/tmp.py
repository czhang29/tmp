...
def process_videos(input_dir, output_dir):
    ...
    hands = mp_hands.Hands(max_num_hands=2, min_detection_confidence=0.75,  # Customizable detection confidence
...
if __name__ == "__main__":
    ...
    output_directory = "/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_hand_no_bgr_confidence_score_0.75"  # Output directory for annotations
