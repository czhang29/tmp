...
def process_videos(input_dir, output_dir):
    ...
    pose = mp_pose.Pose(min_detection_confidence=0.75,
            ...
            with av.open(video_path, 'r') as container:
                ...
                try:
                    for frame in tqdm(container.decode(stream), desc=f'Processing {video_file}'):
                        ...
                        pose_results = pose.process(frame_np)
                        ...
                        if pose_results.pose_landmarks:
                            ...
                            hand_landmarks = {idx: (int(pose_results.pose_landmarks.landmark[idx].x * w),
                                              ...
                                              for idx in [15, 16,17,18,19,20,21,22]}  # Left Hand (15) & Right Hand (16)
                            ...
                            frame_data['pose_confidence'] = pose_confidence

                            # Commented out drawing landmarks
...
if __name__ == "__main__":
    ...
    output_directory = "/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_both_hands_entire_hand_nogbr_confidence_score_0.75"
