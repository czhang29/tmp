...
def process_json_files(base_dir, drop_mode, output_file, handedness_csv=None):
    results = []
...
def main():
    ...
    process_json_files(base_dir, drop_mode, os.path.join(base_dir,
                                                         '/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_nobgr_results/bad_session_drop/metrics_face.csv'),
                       handedness_csv)

    # User selects drop mode for Teeth and Hair tasks
    process_json_files(base_dir, drop_mode, os.path.join(base_dir,
                                                         '/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_nobgr_results/bad_session_drop/metrics_teeth.csv'),
                       handedness_csv)
    process_json_files(base_dir, drop_mode, os.path.join(base_dir,
                                                         '/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_nobgr_results/bad_session_drop/metrics_hair.csv'),
                       handedness_csv)
