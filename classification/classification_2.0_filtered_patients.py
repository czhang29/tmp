...
# Filter control data
# print(crowd_source_df['Session_ID'].isin(excluded_sessions))
crowd_source_df = crowd_source_df[~crowd_source_df['Session_ID'].isin(excluded_sessions)]
# print(sum(metrics_face_df['Session_ID'].isin(patient_excluded_sessions)))
...
# print(compiled_crowd_source_df.shape)
