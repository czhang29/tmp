...
for question in survey_questions:
    for metric in metrics:
        valid_data = filtered_df[filtered_df[question] < 4][[question, metric]].dropna()
...
output_file = "/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_results/score_4_excluded/face_correlation.csv"
