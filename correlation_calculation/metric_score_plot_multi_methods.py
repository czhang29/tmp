...
filtered_df = df[df['mediapipe_hand_face_percentage_frames_used_in_video'] >= 0.1]

# Define velocity metrics and ALSFRS-R questions
velocity_metrics = ['mediapipe_pose_no_filter_face_velocity', 'mediapipe_hand_face_velocity']
