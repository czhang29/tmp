...
output_dir = "/home/czhang/PycharmProjects/ModalityAI/ADL/compare_landmarks"
directories = {
    "pose_nogbr": "/home/czhang/PycharmProjects/ModalityAI/ADL/mediapipe_pose_both_hands_entire_hand_nogbr",
...
for task in os.listdir(recordings_dir):
    ...
    for recording_file in os.listdir(task_path):
        ...
        # Load JSON data for this recording from all directories
        json_data = {}
        for dir_key, dir_path in directories.items():
            json_file_path = os.path.join(dir_path, task, f"{recording_name}.json")
        ...
        while cap.isOpened():
            ...
            annotated_frame = frame.copy()  # Start with the original frame for annotations

            # Plot landmarks from each directory on the same frame
            for dir_key, data in json_data.items():
            ...
            # Save annotated frame after drawing all landmarks from all directories
